#!/bin/bash
# Ansible managed: /workspace/users/albandri10/env/ansible/roles/zap/templates/build.sh.j2 modified on 2014-10-16 01:06:01 by albandri on albandri-laptop-misys
