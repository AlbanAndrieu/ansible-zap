# Ansible managed: /workspace/users/albandri10/env/ansible/roles/zap/templates/Dockerfile.j2 modified on 2014-10-16 01:03:55 by albandri on albandri-laptop-misys.misys.global.ad
#FROM        debian:jessie
